    ...
    <>
      ...
      <div style={styles.section}>
        ...
        <p style={styles.p}>
          ...
          Courriel : <a href="mailto:confidentialite@citadellejiujitsu.ca" style={{ color: "var(--color-citadelle-gold)" }}>
    ...
    <>
      ...
      <div style={styles.section}>
        ...
        <p style={styles.p}>
          ...
          Email: <a href="mailto:confidentialite@citadellejiujitsu.ca" style={{ color: "var(--color-citadelle-gold)" }}>
            confidentialite@citadellejiujitsu.ca
          </a>
        </p>
      </div>
