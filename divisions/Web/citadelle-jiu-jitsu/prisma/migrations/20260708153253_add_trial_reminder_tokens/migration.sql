...
-- CreateEnum
CREATE TYPE "BillingInterval" AS ENUM ('MONTH', 'YEAR', 'ONETIME');
...
-- CreateEnum
CREATE TYPE "PostCategory" AS ENUM ('COMPETITION', 'BELTS', 'ANNOUNCEMENT', 'COMMUNITY');
...
-- CreateIndex
CREATE UNIQUE INDEX "TrialSession_confirmToken_key" ON "TrialSession"("confirmToken");

-- CreateIndex
CREATE UNIQUE INDEX "TrialSession_cancelToken_key" ON "TrialSession"("cancelToken");
...
-- CreateIndex
CREATE INDEX "TrialSession_reminderSentAt_idx" ON "TrialSession"("reminderSentAt");

-- CreateIndex
CREATE INDEX "Waiver_userId_idx" ON "Waiver"("userId");
