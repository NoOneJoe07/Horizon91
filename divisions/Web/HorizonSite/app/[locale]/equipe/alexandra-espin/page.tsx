    ...
    <main>
      ...
      >
        ...
        <div className="max-w-4xl mx-auto flex flex-col items-center gap-6">
          ...
          >
            <span className="text-5xl font-bold" style={{ color: "#5762A2" }}>AE</span>
          </div>
          <div>
            <h1
      ...
      <section className="py-24 px-6" style={{ backgroundColor: "#FFFFFF" }}>
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-lg leading-relaxed mb-8" style={{ color: "rgba(29,29,27,0.60)" }}>
            Alexandra est responsable de toutes les communications de Groupe Étoile Boréale.
            Elle supervise la révision des contenus EN et ES, la stratégie de communications
            et le développement des relations d'affaires. Son profil complet sera publié
            prochainement.
          </p>
